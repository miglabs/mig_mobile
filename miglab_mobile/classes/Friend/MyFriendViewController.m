...
- (void)viewDidLoad
{
    ...
    _searchView.frame = CGRectMake(11.5, 45 + 10, 297, 44);
    [self.view addSubview:_searchView];
    
    //search result view
    _friendTableView = [[UITableView alloc] init];
    _friendTableView.frame = CGRectMake(11.5, 45 + 10 + 44 + 10, 297, kMainScreenHeight - 45 - 10 - 44 - 10 - 10 - 73 - 10);
    ...
    bodyBgImageView.frame = CGRectMake(11.5, 45 + 10 + 44 + 10, 297, kMainScreenHeight - 45 - 10 - 44 - 10 - 10 - 73 - 10);
