...
- (void)viewDidLoad
{
    ...
    //nav bar
    self.navView.titleLabel.text = @"关于Music Soulmate";
    self.bgImageView.hidden = YES;
    
    //icon
    _iconImageView = [[UIImageView alloc] init];
    _iconImageView.frame = CGRectMake((kMainScreenWidth - 86) / 2, 45 + 55, 85.5f, 85.5f);
    ...
    _lblVersion.frame = CGRectMake(10, 45 + 55 + 85 + 15, 300, 25);
    _lblVersion.backgroundColor = [UIColor clearColor];
    _lblVersion.text = [NSString stringWithFormat:@"Music Soulmate V%@", strVersion];
    ...
    //body
    _dataTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 45 + 55 + 85 + 15 + 25 + 50, 320, 150) style:UITableViewStyleGrouped];
    ...
    _datalist = [NSArray arrayWithObjects:@"评个分吧", @"检查新版本", @"使用条款与隐私政策", nil];
